...
| Публикация датасета и чекпоинтов | Воспроизводимость, бенчмарк для сообщества |
| REST API + интеграция | Практическое применение в SOC-командах |
| Подача статьи | Верификация научного вклада |
